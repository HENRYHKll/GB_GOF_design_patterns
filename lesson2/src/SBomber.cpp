...
SBomber::SBomber()
    ...
    , score(0)
{
    FileLoggerSingletone::WriteToLog(std::string(__func__) + " was invoked");
...
void SBomber::ProcessKBHit()
{
    ...
    FileLoggerSingletone::WriteToLog(
        std::string(__func__) + " was invoked. key = ", c);
...
void SBomber::TimeFinish()
{
    ...
    FileLoggerSingletone::WriteToLog(std::string(__func__) + " deltaTime = ",
                        (int)deltaTime);
}
