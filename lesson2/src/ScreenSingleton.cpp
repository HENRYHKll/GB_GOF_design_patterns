...
public:
  virtual void ClrScr() override {
    FileLoggerSingletone::WriteToLog("ClrScr invoke begin");
    getInternalInstance().ClrScr();
    FileLoggerSingletone::WriteToLog("ClrScr invoke end");
  }
  virtual void GotoXY(double x, double y) override {

    FileLoggerSingletone::WriteToLog("GotoXY invoke begin");
    getInternalInstance().GotoXY(x, y);
    FileLoggerSingletone::WriteToLog("GotoXY invoke end");
  }
